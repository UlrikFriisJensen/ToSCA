#!/bin/bash
#SBATCH --job-name=Interpolation_v2_Unitcell_latentLog_2d_latentMSE_biggerDecoder
...
python test.py --test_data validation --setup_json ./models/Interpolation_v2_Unitcell_latentLog_2d_latentMSE_biggerDecoder/setup_json.json
