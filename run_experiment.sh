#!/bin/bash
#SBATCH --job-name=Combined_data_pretrained_3d_allAtoms
...
python test.py --test_data validation --setup_json ./models/Combined_data_pretrained_3d_allAtoms/setup_json.json
