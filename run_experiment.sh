#!/bin/bash
#SBATCH --job-name=Combined_data_beta_annealing_3d_latentMSE_biggerDecoder
...
python test.py --test_data validation --setup_json ./models/Combined_data_beta_annealing_3d_latentMSE_biggerDecoder/setup_json.json
