#!/bin/bash
#SBATCH --job-name=Interpolation_Supercell_latentLog_beta_annealing_2d_latentMSE
...
python test.py --test_data validation --setup_json ./models/Interpolation_Supercell_latentLog_beta_annealing_2d_latentMSE/setup_json.json
