#!/bin/bash
#SBATCH --job-name=Supercell_latentLog_beta_annealing_3d_latentMSE_biggerDecoder
...
python test.py --test_data validation --setup_json ./models/Supercell_latentLog_beta_annealing_3d_latentMSE_biggerDecoder/setup_json.json
