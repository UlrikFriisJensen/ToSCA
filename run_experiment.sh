#!/bin/bash
#SBATCH --job-name=Interpolation_small_Supercell_latentLog_2d_latentMSE_biggerDecoder_v2
...
python test.py --test_data validation --setup_json ./models/Interpolation_small_Supercell_latentLog_2d_latentMSE_biggerDecoder_v2/setup_json.json
