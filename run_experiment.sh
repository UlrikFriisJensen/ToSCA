#!/bin/bash
#SBATCH --job-name=Interpolation_small_Supercell_latentLog_2d_latentMSE_smallerEncoder
...
python test.py --test_data validation --setup_json ./models/Interpolation_small_Supercell_latentLog_2d_latentMSE_smallerEncoder/setup_json.json
