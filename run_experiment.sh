#!/bin/bash
#SBATCH --job-name=Combined_data_harsher_normalization_3d
...
python test.py --test_data validation --setup_json ./models/Combined_data_harsher_normalization_3d/setup_json.json
