#!/bin/bash
#SBATCH --job-name=Combined_data_harsher_normalization_32d_long
...
python test.py --test_data validation --setup_json ./models/Combined_data_harsher_normalization_32d_long/setup_json.json
